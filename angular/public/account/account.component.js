(function(){
    ...
    account.controller('RegisterCtrl', ['$rootScope','$state','$scope','Data','$http','$timeout','$auth', function($rootScope,$state,$scope,Data,$http,$timeout,$auth){
        ...
        $scope.register = function(){
            ...
            Data.signUp.registerUser( $scope.userData, function(data){
                $scope.reply = data;
                //console.log(data);
            }),
                function(response){
...
// <!-- -->
        ...
        $timeout(function () {
            $scope.populateCountries('country', 'state');
        },100);
    ...
    account.controller('LoginCtrl', ['$rootScope','$state','$scope','Data','$auth','$location', function($rootScope,$state,$scope,Data,$auth,$location){
        $scope.loginData ={};
        $scope.loginData =
            {
                password : '00409355',
